...
6. After you log in to the WebCenter Content server, you can see that records is already pre-configured. Refer the Appendix 2 to know how to install Records on WebCenter Content Server.
