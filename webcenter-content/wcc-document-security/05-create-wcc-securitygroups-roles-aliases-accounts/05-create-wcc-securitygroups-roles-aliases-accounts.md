...
6. Click on **Admin** in **Edit Permission** Screen and click **OK**
![This image shows the WCC Administration Edit Permission](./images/edit-permission.png "WCC Administration Edit Permission")
7. Similarly assign Permissions to other Security Group and Role Combination
...
6. Enter the **Predefined Account**. Click **OK**.
