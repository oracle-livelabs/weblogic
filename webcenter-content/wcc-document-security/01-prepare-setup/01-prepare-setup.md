...
### **System Requirements**
  ...
  ![Service Limits ](images/prepare_oci_task1_service_limits.png "Service Limits")
...
### **1.3 Create a Compartment**
  ...
  1. Sign in to the Oracle Cloud Infrastructure Console [ *Using the previous steps mentioned in Task 1.1 above* ]
...
### **2.1 Create VCN**
  ...
  1. Log in to **OCI Console**, navigate to **Networking**, then to **Virtual Cloud Networks**.
    ![OCI Console](images/prepare_oci_task2_step1_1.png "OCI Console")

  2. Select the **wcc** compartment in the **List Scope**, **Compartment** list and Click **Create VCN via Wizard** button
    ![Virtual Cloud Networks Page ](images/prepare_oci_task2_step1_2.png "Virtual Cloud Networks Page for wcc compartment")

  3. Click **Start VCN Wizard**.
        ![Start VCN Wizard](images/prepare_oci_task2_step1_3.png "Start VCN Wizard")

  4. In the **Configuration** page, Provide the below values and click **Next** Button
      - **VCN name**: Provide a name.

                ```
                <copy>wcc-document-security</copy>
                ```
    ...
    ![VCN Configuration](images/prepare_oci_task2_step1_4.png "VCN Configuration")
  ...
  5. In the **Configure public subnet and Configure private subnet** sections, verify the values. If required, specify the correct/required CIDR blocks and click **Next**.
      ...
      ![VCN Configuration - subnets ](images/prepare_oci_task2_step1_5.png "VCN Configuration - configure public subnet and  private subnet")

  6. In the **Review and Create** Page, verify the details and click **Create**
    ![VCN Configuration - Review and Create](images/prepare_oci_task2_step1_6.png "VCN Configuration - Review and Create")

  7. VCN Gets created . Click on **View VCN** to view VCN Info

      ![VCN Created](images/prepare_oci_task2_step1_7_1.png "VCN Created")

      ![VCN Info](images/prepare_oci_task2_step1_7_2.png "VCN Info")
...
### **2.2 Create a New DB System**
  ...
  1. Log in to **OCI Console**, navigate to **Oracle Database**, then to **Oracle Base Database Service**.
      ...
      ![OCI Console](images/prepare_oci_task2_step2_1.png "OCI Console")

  2. Select the **wcc** compartment in the **List Scope**, **Compartment** list and Click **Create DB System** button

      ![Create DB System Page ](images/prepare_oci_task2_step2_2.png "Create DB System Page for wcc compartment")
  ...
  3. Provide the following parameters:
      ...
      - **Name your DB system** : Specify
                ...
                ```
                <copy>wcc-security-DBSystem</copy>
                ```
      ...
      ![Create DB System Page - DB System Information](images/prepare_oci_task2_step2_3_1.png "DB System Information")
      ...
      ![Create DB System Page - storage and DB System Information](images/prepare_oci_task2_step2_3_2.png "Storage and DB System Information")
      ...
      ![Create DB System Page - SSH Keys and License Info](images/prepare_oci_task2_step2_3_3.png "- SSH Keys and License Info")

      - **License**: Choose **Bring Your Own License**

      - **Specify the Network information** - Provide/Select the values as below and Click **Next**.

        - **Virtual cloud network** : Choose the VCN you created earlier - **wcc-document-security**
        ...
        - **Hostname prefix** : Choose an appropriate name.
          ...
          ![Create DB System Page - Network Information](images/prepare_oci_task2_step2_3_4.png "- Network Information")
      ...
      - **Database Information** - Provide/Select the values as below:
        ...
        - **PDB Name** : Specify the PDB name
          ...
          ![Create DB System Page - Database Information](images/prepare_oci_task2_step2_3_5.png "- Database Information")
      ...
      ![Create DB System ](images/prepare_oci_task2_step2_3_6.png "- administrator credentials and backup")
