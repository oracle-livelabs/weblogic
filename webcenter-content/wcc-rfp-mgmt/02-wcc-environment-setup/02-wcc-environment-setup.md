...
3. Provide information about the stack for the instance.
    ...
    - **Virtual Cloud Network**
      ...
      - **Existing WebCenter Content Virtual Cloud Network**: Select the VCN provisioned for WebCenter Content, as **wcc_rfpmgmt_demo**
...
7. Note the Private IP for the WLS Node 1 ( *This will be used for setting up the APEX Application* ) - This will be referred later as **WLS_NODE1_IPADDR** eg: **10.15.xx.xxx**
